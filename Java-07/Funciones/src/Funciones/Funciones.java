...
public class Funciones { //Clase llamada funciones 
	...
	public static void main(String[] args) {
		...
		double distanciaHorizontal = 100.0; //metros 
		double anguloElevacion = Math.toRadians(30);//Conversion a radianes 
		...
		alturaTorre = Math.round(alturaTorre * 100.0)/ 100.0;
		hipotenusa = Math.round(hipotenusa * 100.0)/100.0;
		
		System.out.println("La base es de " + distanciaHorizontal + " metros " + "la altura es de " + alturaTorre + " metros");
		System.out.println("");
